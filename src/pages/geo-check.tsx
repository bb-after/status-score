  ...
  return (
    ...
    >
              ...
              {progress > 30 && progress < 90 && (
                ...
                >
                  <Text fontSize="sm" color="blue.700" textAlign="center">
                    ...
                    from multiple AI engines including GPT-5, Claude, Gemini,
                    and more to give you the most comprehensive insights.
                  </Text>
                </Box>
              )}
            </Box>
      ...
      <PaywallModal
        isOpen={isPaywallOpen}
        onClose={onPaywallClose}
        feature="GEO Reputation Checker"
        description="Analyze your reputation from different geographic locations to see how your brand appears to customers in different cities and regions."
      />
    </ProtectedRoute>
  );
}
